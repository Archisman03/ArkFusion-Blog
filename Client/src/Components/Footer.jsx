...
function FooterElement() {
    return (
        <footer className="w-full bg-gray-100 text-gray-800 py-16">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto">
                    <Link to="/" className="flex justify-center whitespace-nowrap text-xl font-bold dark:text-white">
                        <div className="flex flex-col">
                            ...
                            <p class="text-sm mt-2 text-gray-600">Your gateway to insightful blogs.</p>
                        </div>
                    </Link>
                    <ul className="text-lg flex flex-wrap items-start justify-center gap-7 md:flex-row md:items-center md:gap-50 transition-all duration-500 py-16 mb-10 border-b border-gray-200">
                        <li className="text-center">
                            <p className="text-gray-800 font-semibold hover:text-gray-900">About</p>
                            <ul className="mt-2 space-y-2 text-gray-600 text-sm">
                                <li><a href="#" className="hover:underline block">100 JS Projects</a></li>
                                <li><a href="#" className="hover:underline block">ArkFusion's Blog</a></li>
                            </ul>
                        </li>
                        <li className="text-center">
                            <p className="text-gray-800 font-semibold hover:text-gray-900">Follow Us</p>
                            <ul className="mt-2 space-y-2 text-gray-600 text-sm">
                                <li><a href="#" className="hover:underline block">Github</a></li>
                                <li><a href="#" className="hover:underline block">Discord</a></li>
                            </ul>
                        </li>
                        <li className="text-center">
                            <p className="text-gray-800 font-semibold hover:text-gray-900">Legal</p>
                            <ul className="mt-2 space-y-2 text-gray-600 text-sm">
                                <li><a href="#" className="hover:underline block">Privacy Policy</a></li>
                                <li><a href="#" className="hover:underline block">Terms & Conditions</a></li>
                            </ul>
                        </li>
                    </ul>
                    ...
                    <span class="text-lg text-gray-500 text-center block">©<Link to='/'>ArkFusion's Blog</Link> 2024, All rights reserved.</span>
                </div>
            </div>
        </footer>
...
// function FooterElement3() {
//     return (
//         <footer class="bg-gray-100 text-gray-700 py-8 px-6 md:px-16">
//             <div class="absolute top-0 left-0 w-full h-1 bg-teal-700"></div>

//             <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
//                 {/* <!-- Logo --> */}
//                 <div class="flex items-center space-x-2">
//                     <span class="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-3 py-1 rounded-lg font-bold">
//                         Sahand's
//                     </span>
...
//                     <div>
//                         <h3 class="font-bold uppercase text-gray-800">About</h3>
//                         <ul class="mt-2 space-y-1">
//                             <li><a href="#" class="hover:underline">100 JS Projects</a></li>
//                             <li><a href="#" class="hover:underline">Sahand's Blog</a></li>
//                         </ul>
//                     </div>
//                     <div>
//                         <h3 class="font-bold uppercase text-gray-800">Follow Us</h3>
//                         <ul class="mt-2 space-y-1">
...
//                     </div>
//                     <div>
//                         <h3 class="font-bold uppercase text-gray-800">Legal</h3>
//                         <ul class="mt-2 space-y-1">
...
//             {/* <!-- Bottom Section --> */}
//             <div class="max-w-6xl mx-auto mt-6 border-t pt-4 text-center text-sm flex flex-col items-center">
//                 <p>&copy; 2023 Sahand's Blog</p>
...
//footer for Dark
// function FooterDark() {
//     return <footer class="bg-gray-900 text-gray-400 py-10">
//         <div class="max-w-7xl mx-auto px-5">
//             <div class="flex flex-col md:flex-row justify-between items-center border-b border-gray-700 pb-6">
//                 {/* <!-- Logo & Tagline --> */}
//                 <div class="mb-6 md:mb-0 text-center md:text-left">
//                     <a href="#" class="text-2xl font-bold text-white">ArkFusion</a>
//                     <p class="text-sm mt-2">Your gateway to insightful blogs.</p>
//                 </div>
...
//                 © 2025 ArkFusion. All rights reserved.
//             </div>
//         </div>
//     </footer>
// }